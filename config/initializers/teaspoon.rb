Teaspoon.setup do |config|
  ...
  config.suite :controllers do |suite|
    suite.matcher = "spec/javascripts/controllers/*_spec.{js,js.coffee,coffee}"
  end
  ...
  config.suite :routes do |suite|
    suite.matcher = "spec/javascripts/routes/*_spec.{js,js.coffee,coffee}"
  end
